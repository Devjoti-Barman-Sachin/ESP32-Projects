...
/** This example shows how to delete the Cloud Function. 
 * 
 ...
 * will check for token to be ready in loop prior to delete the Cloud Function.
*/
...
/* The function to delete the Cloud Function */
void deleteFunction();
...
void deleteFunction()
{
    ...
    Serial.print("Delete the Googgle Cloud Function... ");

    if (Firebase.Functions.deleteFunction(&fbdo, FIREBASE_PROJECT_ID /* project id */, PROJECT_LOCATION /* project location */, "helloWorld" /* function name */))
        Serial.printf("ok\n%s\n\n", fbdo.payload().c_str());
    else
