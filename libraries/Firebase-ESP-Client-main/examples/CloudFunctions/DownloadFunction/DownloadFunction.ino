 ...
 * will check for token to be ready in loop prior to generate the Url.
*/
...
void generateUrl()
{
    ...
    Serial.print("Generate the download Url of the Googgle Cloud Function... ");

    if (Firebase.Functions.generateDownloadUrl(&fbdo, FIREBASE_PROJECT_ID /* project id */, PROJECT_LOCATION /* project location */, "helloWorld" /* function name */, "1" /* version id */))
        Serial.printf("ok\n%s\n\n", fbdo.payload().c_str());
    else
