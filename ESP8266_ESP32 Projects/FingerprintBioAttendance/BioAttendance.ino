...
const char *ssid = "Galaxy M31";//Inflexionpiont BD
const char *password = "20000112";//office24194757
const char* device_token  = "dae511e747287774";
//************************************************************************


// Replace with your timezone (https://www.iana.org/time-zones)
...
String getData, Link;
String URL = "http://dbs.unaux.com/attendance/getdata.php"; //computer IP or the server domain
//************************************************************************
...
void DisplayFingerprintID() {
  ...
  //No finger detected
    ...
    display.println("Inflexionpoint BD");

    display.setTextSize(2);
    display.setCursor(10, 26);
    // Display hours with two decimal places
    if (hours < 10) {
      display.print("0");
    }
    display.print(hours);
    ...
    // Display minutes with two decimal places
    ...
    // Display seconds with two decimal places
...
void connectToWiFi() {
  ...
  display.drawBitmap( 73, 4, Wifi_start_bits, Wifi_start_width, Wifi_start_height, WHITE);
  display.display();
  delay(4000);
